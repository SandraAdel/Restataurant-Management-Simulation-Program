...
protected:
	...
	float totalMoney;	//Total order money
...
public:
	...
	float getTotalMoney() const;                // --> 3alshan lama arateb el VIPs fel queue beta3hom
	void incrementTotalMoney( float money );    // --> 3alshan el promotion event
