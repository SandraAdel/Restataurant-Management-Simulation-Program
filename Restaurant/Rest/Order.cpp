...
Order :: Order(int id, ORD_TYPE r_Type, int arrtime, int size, double money)      // --> ma3mltesh intialize le finish time, service time w distance 3alshan law tel3o garbage a3raf eni ma3mltlhomsh set
{
...
float Order ::  getTotalMoney() const
{
	return totalMoney;
}

void Order :: incrementTotalMoney( float money )
{
	totalMoney += money;
}
